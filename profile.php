    ...
    <div class="row">
        <div class=col mt-2 mb-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="profileEmail" readonly>
            </div>
            <div class="form-group">
                <label for="">Username</label>
                <input type="text" class="form-control" name="profileUsername">
            </div>
            <div class="form-group">
                <label for="">Phone number</label>
                <input type="text" class="form-control" name="profilePhone">
            </div>
            <div class="form-group">
